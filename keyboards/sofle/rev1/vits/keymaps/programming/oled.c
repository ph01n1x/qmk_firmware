...
static void render_animation(int y) 
{
    ...
    static const char PROGMEM kaki[2][FRAME_SIZE] = 
    {
        {
        // 'kaki1', 32x32px
    ...
    void draw_animation(void) 
    {
        ...
        if (current_animation !=  ANIMATION_SLEEP && timer_elapsed32(keyevent_timer) > 10000)
        {
            ...
            else if (timer_elapsed32(keyevent_timer) > 23000)
            {
            ...
            else if (timer_elapsed32(keyevent_timer) > 20000)
            {
        ...
        switch (current_animation)
        {
            ...
            case ANIMATION_MATI:
                ...
                {
                    oled_write_raw_P(mati[2], sizeof(mati[2]));
                }
